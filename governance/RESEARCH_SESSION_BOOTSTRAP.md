...
2. Read the Core Card first, then only the protocol sections material to the immediate task. Do not require a full reread of the entire protocol for every question.
...
## Current protocol at bootstrap creation

General Cross-Project Research Protocol v0.7.7, dated 13 September 2026. This line is a pointer, not a permanent claim of currency. The highest later active version supersedes it.
